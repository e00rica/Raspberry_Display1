...
class MyPresenter(QtCore.QObject):
    ...
    def __init__(self, model, view, app):
        ...
        self.connectSignals()   # connect alla signaler
    ...
    def connectSignals(self):
        ...
        self.model.received_prf.connect(self.mainpresenter.prf)         # connector to model signal received_prf
        self.model.answer_timeout.connect(self.mainpresenter.noAnswer) # connector to model signal answer_timeout

        
    def quit(self):
        self.mainpresenter.quit()
        self.model.quit()
